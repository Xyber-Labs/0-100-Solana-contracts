...
pub fn claim_platform(ctx: Context<ClaimPlatform>) -> Result<()> {
    ...
    let base_to_claim =
        project_pool.earned_base_by_platform.saturating_sub(project_pool.claimed_base_by_platform);
    let quote_to_claim = project_pool
        .earned_quote_by_platform
        .saturating_sub(project_pool.claimed_quote_by_platform);
        ...
        transfer_checked(
            CpiContext::new_with_signer(
                ...
                TransferChecked {
                    ...
                    to: ctx.accounts.platform_base_ata.to_account_info(),
        ...
        transfer_checked(
            CpiContext::new_with_signer(
                ...
                TransferChecked {
                    ...
                    to: ctx.accounts.platform_quote_ata.to_account_info(),
                    authority: ctx.accounts.project_authority.to_account_info(),
    ...
    project_pool.claimed_base_by_platform = project_pool.earned_base_by_platform;
    project_pool.claimed_quote_by_platform = project_pool.earned_quote_by_platform;
    ...
    emit!(PlatformClaim {
        user: ctx.accounts.platform_wallet.key(),
...
pub struct ClaimPlatform<'info> {
    ...
    /// CHECK: Platform wallet authority
    #[account(
        constraint = platform_wallet.key() == config.platform_wallet @ crate::errors::ErrorCode::InvalidAuthority
    )]
    ...
    pub platform_base_ata: InterfaceAccount<'info, TokenAccount>,
    ...
    pub platform_quote_ata: InterfaceAccount<'info, TokenAccount>,
