...
export class TxBuilder {
    ...
    async initLaunchIx(params) {
        ...
        const instruction = await this.program.methods
            .initLaunch(params.hardCapLamports, params.minRaiseLamports, params.perWalletCap, params.tauLamports, params.saleAllocation, params.lpAllocation, params.fundingDurationDays)
            .accountsStrict({
            admin: params.admin,
    ...
    async initLaunchTx(params) {
        ...
        const initializeMintIx = createInitializeMintInstruction(params.saleMint.publicKey, 6, params.admin, params.admin);
