...
export default {
    ...
    create(provider, program) {
        ...
        function getPoolPda(launch) {
            return PublicKey.findProgramAddressSync([Buffer.from("pool"), launch.toBuffer()], program.programId);
        }
        // -------------- Utility --------------
        ...
        async function fetchPoolState(launch) {
