...
exports.ENGINE_PROGRAM_ID = void 0;
...
exports.ENGINE_PROGRAM_ID = new web3_js_1.PublicKey("HMVJWXWhpxEWWGhvLHYnTvkmYJcA819jAxw3EgdNYiYb");
exports.default = {
    idlJson: idl,
    ...
    create(provider, program) {
        ...
        function getLaunchPda(saleMint) {
            return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("launch"), saleMint.toBuffer()], program.programId);
        }
        function getEscrowPda(launch) {
            return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("escrow"), launch.toBuffer()], program.programId);
        }
        function getRosterPda(launch) {
            return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("roster"), launch.toBuffer()], program.programId);
        }
        function getSelectionPda(launch) {
            return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("selection"), launch.toBuffer()], program.programId);
        }
        function getUserContributionPda(launch, user) {
            return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("user"), launch.toBuffer(), user.toBuffer()], program.programId);
        }
        function getMintAuthPda(launch) {
            return web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("mint_auth"), launch.toBuffer()], program.programId);
        }
        // -------------- Utility --------------
        ...
        function buildCreateAtaIx(args) {
            ...
            const ix = (0, spl_token_1.createAssociatedTokenAccountInstruction)(args.payer, ata, args.owner, args.mint, spl_token_1.TOKEN_PROGRAM_ID, spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID);
            return { ata, ix };
        }
        // =============================
        //          TX methods
