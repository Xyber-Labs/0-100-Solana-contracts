...
export type Engine = {
  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "mintAuth";
          docs: ['Seeds: ["mint_auth", launch_state]'];
          pda: {
            seeds: [
              {
                kind: "const";
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "escrow";
          docs: ["Escrow account (PDA off launch_state)"];
          writable: true;
        },
        {
          name: "launch";
    ...
    },
    {
      ...
      discriminator: [75, 162, 31, 198, 192, 109, 36, 169];
      accounts: [
        {
          name: "creator";
          writable: true;
    ...
    {
      name: "initRoster";
      docs: ["Initialize roster account."];
      discriminator: [231, 223, 153, 129, 236, 138, 47, 253];
      accounts: [
        {
          name: "payer";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [82, 138, 120, 1, 122, 136, 206, 67];
      accounts: [
        {
          name: "selectionState";
          writable: true;
    ...
    {
      name: "setSeed";
      docs: ["Permissionless seed setter using recent blockhash."];
      discriminator: [63, 37, 179, 25, 135, 54, 47, 119];
      accounts: [
        {
          name: "payer";
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              ...
              {
                kind: "const";
                value: [115, 101, 108, 101, 99, 116, 105, 111, 110];
              },
              {
                kind: "account";
                path: "launchState";
  ...
  accounts: [
    ...
    {
      name: "launchState";
      discriminator: [190, 149, 142, 151, 19, 196, 133, 100];
    },
    {
      name: "poolState";
    ...
    {
      name: "roster";
      discriminator: [211, 108, 170, 22, 253, 177, 162, 194];
    },
    {
      name: "selectionState";
      discriminator: [235, 126, 97, 31, 31, 163, 172, 135];
    },
    {
      name: "userContribution";
      discriminator: [89, 250, 199, 201, 234, 203, 119, 235];
    }
  ];
  events: [
    {
      name: "batchProcessed";
      discriminator: [199, 28, 80, 191, 111, 11, 127, 180];
    },
    {
      name: "depositMade";
      discriminator: [210, 201, 130, 183, 244, 203, 155, 199];
    },
    {
      name: "fundingPeriodStarted";
      discriminator: [24, 17, 247, 144, 200, 76, 119, 198];
    },
    {
      name: "launchInitialized";
      discriminator: [60, 143, 196, 55, 214, 166, 10, 63];
    },
    {
      name: "numBlocksUpdated";
      discriminator: [169, 68, 39, 54, 104, 241, 228, 223];
    },
    {
      name: "poolCreated";
    ...
    },
    {
      ...
      discriminator: [111, 28, 99, 210, 82, 158, 188, 249];
    },
    {
      name: "seedSet";
      discriminator: [9, 179, 143, 172, 250, 146, 42, 6];
    },
    {
      name: "selectionFinalized";
      discriminator: [111, 84, 253, 234, 76, 136, 103, 185];
    },
    {
      name: "tokensClaimed";
