...
export type Engine = {
  ...
  instructions: [
    ...
    {
      name: "closeDeposits";
      docs: ["Close deposits, build prefix, set N and K."];
      discriminator: [32, 132, 87, 145, 240, 56, 34, 245];
      accounts: [
        {
          name: "admin";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [3, 226, 213, 146, 195, 126, 174, 228];
      accounts: [
        {
          name: "selectionState";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [111, 108, 90, 115, 178, 90, 24, 228];
      accounts: [
        {
          name: "admin";
          writable: true;
    ...
    {
      name: "openFunding";
      docs: ["Open funding window."];
      discriminator: [255, 94, 231, 132, 50, 44, 163, 83];
      accounts: [
        {
          name: "admin";
          writable: true;
