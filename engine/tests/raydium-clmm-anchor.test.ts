...
describe("Raydium CLMM Pool Creation - Fast Flow", () => {
  ...
  const multisigKeypair = loadKeypair("localnet/multisig.json");
  const deployerKeypair = loadKeypair("localnet/deployer.json");
  const backendKeypair = loadKeypair("localnet/backend.json");
  const xyberMintKeypair = loadKeypair("localnet/xyber-mint.json");
  const treasuryKeypair = loadKeypair("localnet/treasure.json");
  const platformKeypair = loadKeypair("localnet/platform.json");
  const creatorKeypair = loadKeypair("localnet/creator.json");
  const buyer1Keypair = loadKeypair("localnet/buyer1.json");
  const buyer2Keypair = loadKeypair("localnet/buyer2.json");
  const buyer3Keypair = loadKeypair("localnet/buyer3.json");
  const communityWallet = loadKeypair("localnet/community-signer.json");
